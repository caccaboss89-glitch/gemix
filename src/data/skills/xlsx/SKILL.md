---
name: xlsx
description: Work with spreadsheets in the workspace — open, read, edit, clean, or create .xlsx/.xlsm/.csv/.tsv files; add columns, compute formulas, format cells, build charts, restructure messy tabular data, or convert between tabular formats. Use whenever a spreadsheet is the primary input or output in /workspace/. Do NOT use when the real deliverable is a Word/PDF document, an image, or a standalone script — even if tabular data is involved.
---
