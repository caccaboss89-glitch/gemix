...
with page number labels. Use it to see what a document looks like before
and after edits.

Usage:
    python /skills/docx/scripts/render_doc.py /workspace/document.docx
    # Creates: doc_pages.jpg in the current directory

    python /skills/docx/scripts/render_doc.py /workspace/document.docx /workspace/pages --cols 4
    # Creates: /workspace/pages.jpg (4 columns)

Note: convert_doc.py --to images creates individual page files.
      render_doc.py creates a single grid image for a quick visual overview.
"""
