...
Produces a clean copy with every tracked insertion/deletion applied.
Uses headless LibreOffice (soffice) via a small StarBasic macro.

Usage:
    python /skills/docx/scripts/accept_changes.py /workspace/input.docx /workspace/clean.docx
"""
