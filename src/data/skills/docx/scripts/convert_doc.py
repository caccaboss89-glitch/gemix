"""Unified document format converter (LibreOffice + poppler).

Handles .doc->.docx, .dotx->.docx, .docx->pdf, .docx->images in one command.
All paths are absolute under /workspace/.

Usage:
    python /skills/docx/scripts/convert_doc.py /workspace/document.docx --to images
    python /skills/docx/scripts/convert_doc.py /workspace/document.docx --to pdf
    python /skills/docx/scripts/convert_doc.py /workspace/legacy.doc --to docx
    python /skills/docx/scripts/convert_doc.py /workspace/template.dotx --to docx
"""
