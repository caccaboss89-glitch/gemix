...
- **Readonly writes**: NEVER write back to `/readonly/...`. To edit a user-provided document, first `cp /readonly/history/<file>.docx /workspace/temp/<file>.docx`, then operate on the writable copy.
