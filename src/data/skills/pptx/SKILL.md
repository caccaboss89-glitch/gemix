...
- **Readonly writes**: NEVER write back to `/readonly/...`. To edit a user-provided deck, first `cp /readonly/history/<file>.pptx /workspace/temp/<file>.pptx`, then operate on the writable copy.
