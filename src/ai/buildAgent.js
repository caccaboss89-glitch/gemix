...
function _buildSystemPrompt(workspaceId, renamedAttachments) {
  ...
  return [
    ...
    '  PDF deliverables: LaTeX/TikZ → write .tex + pdflatex (not the pdf skill). reportlab/pypdf PDFs → read /skills/pdf/SKILL.md. Word → /skills/docx/SKILL.md. Rich docx/pdf: embed images proactively (staged files, matplotlib, or web_x_search search_images=true).',
