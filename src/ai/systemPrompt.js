...
function buildPersonalCloudPointer(ctx) {
  ...
  - Call agentic_unlock for: cloud storage, computation, file generation/editing, yt-dlp, OCR, data work.
  - Do NOT call unlock for: normal chat, web search, voice replies, scheduling.
  </PersonalCloud>\n`;
}
