...
const VOICE_RESPONSE_FIELD_DESC =
  'The reply shown to the user. When `voice` is true this text is spoken by TTS: spoken words and voice tags only — '
  + 'no emoji, symbols (_ " \\ * ~ ` # …), markdown, @mentions, or user tags; punctuation . , ! ? \' only. '
  + 'Keep under 1000 characters; longer voice replies are sent as text. ALWAYS weave voice tags for a natural '
  + 'delivery (never read aloud). When `voice` is false: plain text per the system prompt Format line, no voice tags. '
