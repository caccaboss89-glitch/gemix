  ...
  return makeTool({
    ...
    description: isAdmin
      ...
      : (isActiveMember
        ...
        : 'Programma promemoria e attività future per te. Scrivi ogni promemoria come se fosse inviato nella data/ora programmata. Puoi programmare più task contemporaneamente (se richiesto fallo per ottimizzare costi/tempo): passa un array di oggetti task con i diversi orari/testi.'),
    properties: {
      tasks: {
        type: 'array',
        items: {
