...
function formatSkillsForPrompt(skills) {
  ...
  let xml = '  <Skills>\n';
  xml += '    <Instruction>CRITICAL: If a skill matches the request, you MUST call `read_file` on its &lt;Source&gt; path IMMEDIATELY. DO NOT write manual scripts, bash or guess code before reading the documentation or search images with save_to_disk=false.</Instruction>\n';
