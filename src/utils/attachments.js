...
//
// Exactly one of buffer or filePath must be set. Helper functions handle
 ...
 * - Audio/video delivered from the build tool (waTempLinkPreferred)
 * Imagine / generate_video / search images try direct send first; fallback on failure.
 */
